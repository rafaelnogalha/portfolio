  ...
  return(
    <>
      ...
      <div className={styles.contentContainer}>
        <h1>
        I'm a technician, graduated, in <span className="curse">Systems Development</span> from the Federal Institute 
        of Education, Science and Technology of Brasília. Now,
        i'm current student of <span className="curse">Computer Science</span> at University of Brasilia,
